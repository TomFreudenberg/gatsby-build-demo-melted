...
const _require2 = require(`../utils/get-static-dir`),
      syncStaticDir = _require2.syncStaticDir;

const developHtml = require(`./develop-html`);

const _require3 = require(`../utils/path`),
...
const _require4 = require(`../utils/tracer`),
      initTracer = _require4.initTracer;
